...
/**
 * Drupal 7 node source from database with no language.
 *
 * @MigrateSource(
 *   id = "node_no_lang",
 *   source_module = "node"
 * )
 */
class NodeNoLanguage extends FieldableEntity {
  ...
  public function prepareRow(Row $row) {
    ...
    foreach ($this->getFields('node', $type) as $field_name => $field) {
      // Removed the language here to prevent errors.
      $row->setSourceProperty($field_name, $this->getFieldValues('node', $field_name, $nid, $vid));
    }
